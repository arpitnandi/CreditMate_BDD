...
Scenario Outline: Validate with Valid credentials for all User Types
    ...
    #Examples: 
      ...
      #| Lender            | Lender Admin  | My Rules Admin      | arpit.n@testyantra.com | #Arpit@92     | &&123$_@1241.gfh     |                  |
...
Scenario Outline: Validate with Invalid credentials for all User Types
    Given User launches the application
    When login as <Interface> user
